...
# Función para mostrar texto y hablar
...
# Título
titulo = tk.Label(ventana, text="Historia y evolución de la graficación por computadora",
                  font=("Arial", 16, "bold"), bg="#f0f4f8", fg="#2c3e50")
titulo.pack(pady=10)

# Área de texto desplazable (scroll)
text_area = scrolledtext.ScrolledText(ventana, wrap=tk.WORD,
font=("Arial", 12), height=10, width=80, bg="#ffffff")
...
for i, decada in enumerate(historia_contenido):
    boton = tk.Button(frame_botones, text=decada, width=15,
                     font=("Arial", 10, "bold"),
                     bg=colores[i], fg="white",
